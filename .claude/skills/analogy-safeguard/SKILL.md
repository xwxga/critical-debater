...
- Debate turn content (full DebateTurn JSON or specific argument sections)

## Output / 输出

- Per analogy: `pass` | `fail` with reasons
- Overall content share assessment
...
2. **Evaluate**: For each analogy, assess similarities and differences
3. **Estimate**: Assess overall content share semantically
4. **Report**: Return per-analogy pass/fail and overall assessment
