...
- See `../_shared/references/data-contracts.md` for the DebateTurn output schema
...
- See `../_shared/references/data-contracts.md` for exact schema
...
1. Use `search` capability to find additional supporting evidence
2. Use `fetch` capability to extract content
